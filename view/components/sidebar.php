...
<div class="sidebar">
    ...
    <a href="daftar_matkul.php" class="sidebar-item <?= ($active_page == 'matkul') ? 'active' : '' ?> text-decoration-none">
    ...
    <a href="daftar_tugas.php" class="sidebar-item <?= ($active_page == 'tugas') ? 'active' : '' ?> text-decoration-none">
